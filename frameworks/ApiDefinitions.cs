...
namespace FMDB
{
	...
	interface FMResultSet
	{
		...
		[return: NullAllowed]
		unsafe byte* UTF8StringForColumn (string columnName);
	...
	interface NSObject_FMDatabasePoolDelegate
	{
		...
		void DatabasePool (FMDatabasePool pool, FMDatabase database);
	}
	...
	interface FMDatabase
	{
		...
		[return: NullAllowed]
		unsafe FMResultSet ExecuteQuery (string sql, sbyte* args);
		...
		unsafe void MakeFunctionNamed (string name, int arguments, Action<void*, int, void**> block);
